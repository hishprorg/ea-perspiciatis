...
![CI](https://github.com/hishprorg/ea-perspiciatis/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@hishprorg/ea-perspiciatis.svg?style=flat)](https://www.npmjs.com/package/@hishprorg/ea-perspiciatis)
...
* YMMV, see [this issue](https://github.com/hishprorg/ea-perspiciatis/issues/91) where other algorithms such as crc32 for small payloads and murmurhash3-wasm for big buffers have performed better than the mentioned recommendations
